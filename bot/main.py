                ...
                while sent_for_dest < int(qty) and creators_attempted < 3 and creator:
                    ...
                    while sent_for_dest < int(qty) and pages_tried < 10:
                        ...
                        for item in media_items:
                            ...
                            try:
                                msg_id = await uploader._upload_single(channel_id=dest_id, media_item=item, caption=caption)
                            except Exception as e:
                ...
                while tries < 5 and sent < 1:
                    ...
                    while sent < int(page_items) and pages_tried < max_pages:
                        ...
                        for item in media_items:
                            ...
                            try:
                                msg_id = await self.uploader._upload_single(channel_id=vip_chat_id, media_item=item, caption=caption)
                            except Exception as e:
